 ...
 *
 * This class enables hierarchical modeling. A renderable can be attached to 
 * another parent renderable. In that case, the model matrix defines the 
 * location of the instance with respect to the location of the parent in world space.
 * If no parent is defined, the model matrix directly defines the location 
 * of the instance in world space.
 *
...
public:
     ...
     * If this renderable as a parent, the model matrix is relative to 
     * its parent space.
     ...
     *
     * Computes and return the model matrix defining the 
     * absolute location of the instance in world space.
     *
     * If a parent is defined, the hierarchy of parent(s)
     * model matrices is traversed upward. 
     *
