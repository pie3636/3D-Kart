...
{ // Commentée car segfault et ne marche pas
/*
...
bool testKartKart(const KartPtr &k1, const KartPtr &k2) // Nous n'avons pas le temps de faire mieux (hitbox rectangulaire souhaitée)
{
